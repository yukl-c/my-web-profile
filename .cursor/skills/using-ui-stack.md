...
When working on this repository's profile website:

1. Primary accent is **amber**, not blue-first defaults.
2. Prefer `stone`/neutral backgrounds with amber headings, links, and buttons.
3. Keep typography fixed and readable for resume-style content.
4. Prioritize clarity and contrast over dense dashboards or complex motion.
5. Follow `.cursor/plans/design-spec.md` for layout decisions sourced from paper wireframes.
